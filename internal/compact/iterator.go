...
func NewIter(
	...
	i := &Iter{
		...
		rangeKeySuffixCmp: cfg.Comparer.CompareRangeKeySuffixes,
		cfg:               cfg,
	...
	i.rangeKeyCompactor = MakeRangeKeySpanCompactor(i.cmp, i.rangeKeySuffixCmp, cfg.Snapshots, cfg.RangeKeyElision)
