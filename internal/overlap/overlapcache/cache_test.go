...
// whiteboard is a data structure that maintains multiple lines of text and
// allows writing at arbitrary locations.
// TODO(radu): move this to a datadriven/diagram package.
